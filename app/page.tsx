...
export default async function Home() {
  return (
    <div className="font-sans relative h-max w-full bg-[#222222]">
      <div className="justify-evenly h-screen lg:mt-0 w-screen mx-0 sm:mx-auto flex flex-col sm:w-4/5 lg:w-3/4 relative">
        ...
        <div className="mx-auto grid lg:grid-cols-2">
          <h1 className="z-50">
            ...
            />
            <div className="font-light mt-12 text-base lg:text-lg xl:text-xl max-w-[50rem] text-gray-50 text-center sm:text-left z-30  mx-auto sm:mx-0">
              <span className="text-white drop-shadow-md shadow-black italic">
                Doradztwo na każdym etapie dofinansowania termomodernizacji
                budynków.
              </span>
            </div>
            <div className="flex z-30 w-full space-x-3 justify-center items-center sm:w-max mt-12 mx-auto sm:mx-0">
              <Link
                target="_blank"
                href={`https://hexon.eco`}
                className="py-3 pr-5 w-max sm:w-auto hover:scale-110 duration-200 in-out text-white rounded-lg cursor-pointer"
              >
                ZOSTAŃ DORADCĄ
              </Link>
              ...
              <Link
                target="_blank"
                href={`https://hexon.eco`}
                className="py-3 px-5 w-max sm:w-auto bg-gradient-to-br from-[#C5FF17] to-[#33E5CF] hover:scale-110 duration-200 ease-in-out text-zinc-800 rounded-lg cursor-pointer font-bold"
              >
                DOFINANSOWANIE
              </Link>
            </div>
